    ...
    return (
        <div className='w-full mt-12 max-w-[1440px] mx-auto sm:mt-16 md:mt-20 lg:mt-24 px-4 sm:px-6 md:px-8'>
            <div className='p-6 sm:p-8 md:p-10 lg:p-12'>
                <h2 className='text-center [font-size:var(--text-24)] md:[font-size:var(--text-48)] lg:[font-size:var(--text-48)] font-[var(--font-semibold)] mb-8 sm:mb-10 md:mb-12 lg:mb-16'>Our Service Promise</h2>
                    ...
                    {services.map((service, index) => {
                        ...
                        return (
                            <div key={index} className='flex flex-col items-center text-center max-w-full sm:max-w-xs md:max-w-sm lg:max-w-md px-3 sm:px-4 md:px-5 lg:px-6'>
                                ...
                                <h3 className='[font-size:var(--text-18)] md:[font-size:var(--text-20)] lg:[font-size:var(--text-24)] font-[var(--font-bold)] mb-2 sm:mb-3'>{service.title}</h3>
                                <p className='[font-size:var(--text-14)] md:[font-size:var(--text-16)] lg:[font-size:var(--text-16)] text-[var(--gray)] leading-relaxed'>{service.description}</p>
                            </div>
                        )
                    })}
                </div>
